...
public class EventSourceClientHandler extends ChannelInboundMessageHandlerAdapter<Object> {
    ...
    FullHttpRequest getConnectHttpRequest() {
        ...
        {
            String credentials = this.authUser + ":" + this.authPassword;
            String base64EncodedCredentials = Base64.encodeToString(credentials.getBytes(), Base64.NO_WRAP);
            request.headers().add(HttpHeaders.Names.AUTHORIZATION, "Basic " + base64EncodedCredentials);
        }
        ...
        if (lastEventId != null && !lastEventId.equals("")) {
